...
{
	std::ofstream resultsFile("Output_File.txt");
	if (m_txt4->GetValue().empty() == true || m_txt6->GetValue().empty() == true || m_txt8->GetValue().empty() == true || m_txt10->GetValue().empty() == true || m_txt12->GetValue().empty() == true)
		m_msg4->ShowModal();
	else
	{
...
{
	std::ofstream resultsFile("Output_File.txt");
	if (m_txt15->GetValue().empty() == true || m_txt16->GetValue().empty() == true || m_txt17->GetValue().empty() == true || m_txt18->GetValue().empty() == true || m_txt19->GetValue().empty() == true || m_txt20->GetValue().empty() == true)
	{
		m_msg4->ShowModal();
	}
	else
